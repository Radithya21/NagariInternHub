                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {pegawai.map((pgw) => (
                        <div key={pgw.id} className="bg-white rounded-2xl shadow p-6 flex flex-col items-center relative group transition hover:shadow-lg">
                            ...
                            <div className="text-xs text-gray-400 mb-3 text-center uppercase tracking-wide">MEMBER SINCE {pgw.created_at ? new Date(pgw.created_at).toLocaleDateString('en-US', { month: 'long', day: '2-digit', year: 'numeric' }).toUpperCase() : '-'}</div>
                            <div className="mb-3">
