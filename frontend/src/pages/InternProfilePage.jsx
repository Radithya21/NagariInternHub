...
function InternProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 flex flex-col overflow-x-hidden">
      <div className="flex-1 flex flex-col">
        <div className="container mx-auto px-2 md:px-6 py-8 w-full">
          {/* Header */}
          ...
          {/* Profile & Password Cards Horizontal Layout */}
          <div className="flex flex-col md:flex-row gap-8 mb-8 w-full">
            ...
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 relative overflow-hidden flex-1 min-w-0"
            >
